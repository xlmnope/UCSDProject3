// This is going to insert our user information to the database using sequelize
// require the bcrypt-nodejs package to encrypt and decrypt the password that the user creates or logs in with.
...
module.exports = function(sequelize, DataTypes) {
  ...
  // Creating a custom method for our admin model. 
